...
import SidebarData from "../../data/dashboard/leaton-user-dashboard/dashboardsiderbar.json";

const MyDashboardSidebar = ({user}) => {
          ...
          <div className="content-item-content">
            <div className="rbt-default-sidebar-wrapper">
              <div className="section-title mb--20">
                <h6 className="rbt-title-style-2">Welcome, {user.firstname}</h6>
              </div>
