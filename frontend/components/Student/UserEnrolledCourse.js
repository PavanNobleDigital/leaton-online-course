...
import Courses from "../../data/dashboard/instructor/enrolled-course.json"
import CourseWidgets from "../Instructor/Dashboard-Section/widgets/CourseWidget";

const UserEnrolledCourses = ({enrolledcourses, completedCourse}) => {
        ...
        <div className="content">
          ...
          <div className="tab-content">
            ...
            >
              ...
              {enrolledcourses.slice(0, 3)?.map((slide, index) => (
                  <div
            ...
            >
              <div className="row g-5">
              {completedCourse.slice(0, 4)?.map((slide, index) => (
                  <div
                    className="col-lg-4 col-md-6 col-12"
