              ...
              <div className="content">
                <div className="inner">
                  <div className="rbt-new-badge rbt-new-badge-one">
                    <span className="rbt-new-badge-icon">🏆</span> Loggedin The Leader in
                    Online Learning
                  </div>
                  <h1 className="title">
                    Welcome to {" "}
                  ...
                  <p className="description">
                    This app includes all the necessary information. Please login or register below to start.{" "}
