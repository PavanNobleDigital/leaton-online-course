              ...
              <div className="accordion-item card" key={innerIndex}>
                ...
                >
                  <div className="accordion-body card-body pr--0">
                    <ul className="rbt-course-main-content liststyle chapters">
                    {item.chapterItem.map((chapter_item) => (
                        <li><span style={{}} className="chapter_name">{chapter_item.name}</span>
                        <ul className="rbt-course-main-content liststyle lesson" style={{margin: "15px 0px 0px 20px"}}>

                          {chapter_item.lessonItem.map((list, subIndex) => (
                        <li key={subIndex}>
                          <Link href="/lesson">
