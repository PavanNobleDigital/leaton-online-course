...
const CourseInfoSidebar = ({ checkMatchCourses }) => {
  ...
  return (
    <>
      ...
      <div className="content-item-content">
        ...
        Check for the logged-in 'user_id' is present in the JSON 

                  Filename: data/course-details/coursedetails.json
                  "enrollent_user_ID": [1, 2]

                  if the user ID is NOT present in the above list the show add to cart
        
        */
        }


{checkMatchCourses.user_id && (
              <p>{checkMatchCourses.courseImg}</p>
            )}
