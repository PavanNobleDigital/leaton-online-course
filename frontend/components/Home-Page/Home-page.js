              ...
              <div className="content">
                <div className="inner">
                  <div className="rbt-new-badge rbt-new-badge-one">
                    <span className="rbt-new-badge-icon">🏆</span> Hi {user.full_name ? user.full_name: user.name},
                  </div>
                  <h1 className="title">
                    Welcome to{" "}
                    <span className="color-primary">Leaton App</span>{" "}
                    Platform for Drive Your fitness.
                  </h1>
